...
public class GcsStaticConfigurationUpdater
{
    private final boolean useGcsAccessToken;
    private final String jsonKeyFilePath;

    @Inject
    public GcsStaticConfigurationUpdater(HiveGcsConfig config)
    {
    ...
    public void updateConfiguration(Configuration config)
    {
        ...
        if (useGcsAccessToken) {
            ...
            config.set("fs.gs.auth.service.account.keyfile", jsonKeyFilePath);
        }
    }
}
