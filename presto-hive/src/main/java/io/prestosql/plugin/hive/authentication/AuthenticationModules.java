...
public final class AuthenticationModules
{
    ...
    public static Module kerberosHiveMetastoreAuthenticationModule()
    {
        return new Module()
        {
            ...
            @Singleton
            @ForHiveMetastore
            HadoopAuthentication createHadoopAuthentication(MetastoreKerberosConfig config, HdfsConfigurationStaticUpdater updater)
            {
    ...
    public static Module kerberosHdfsAuthenticationModule()
    {
        return new Module()
        {
            ...
            @Singleton
            @ForHdfs
            HadoopAuthentication createHadoopAuthentication(HdfsKerberosConfig config, HdfsConfigurationStaticUpdater updater)
            {
    ...
    private static HadoopAuthentication createCachingKerberosHadoopAuthentication(String principal, String keytabLocation, HdfsConfigurationStaticUpdater updater)
    {
