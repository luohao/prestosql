...
import io.prestosql.plugin.hive.gcs.GasConfigurationInitializer;
...
public class HdfsConfigurationInitializer
{
    ...
    private final GasConfigurationInitializer gasConfigurationInitialize;
    ...
    @Inject
    public HdfsConfigurationInitializer(HiveClientConfig config, S3ConfigurationUpdater s3ConfigurationUpdater, GasConfigurationInitializer gasConfigurationInitialize)
    {
        ...
        this.gasConfigurationInitialize = requireNonNull(gasConfigurationInitialize, "gasConfigurationInitialize is null");
    }
    ...
    public void updateConfiguration(Configuration config)
    {
        ...
        gasConfigurationInitialize.updateConfiguration(config);
    }
