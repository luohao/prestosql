...
public class ClientOptions
{
    ...
    public final List<ClientExtraCredentials> extraCredentials = new ArrayList<>();
    ...
    public ClientSession toClientSession()
    {
        return new ClientSession(
                ...
                emptyMap(),
                emptyMap(),
                toCredentials(extraCredentials),
                null,
    ...
    public static Map<String, String> toCredentials(List<ClientExtraCredentials> credentials)
    {
        ImmutableMap.Builder<String, String> builder = ImmutableMap.builder();
    ...
    public static final class ClientExtraCredentials
    {
        private final String name;
        private final String value;
        ...
        public ClientExtraCredentials(String extraCredentials)
        {
            ...
            checkArgument(nameValue.size() == 2, "Connector token: %s", extraCredentials);
        ...
        @VisibleForTesting
        public ClientExtraCredentials(String name, String value)
        {
            this.name = requireNonNull(name, "name is null");
            this.value = value;
        }
        ...
        public boolean equals(Object o)
        {
            ...
            ClientExtraCredentials other = (ClientExtraCredentials) o;
